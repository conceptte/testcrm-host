<?php
// source: array
// source: /var/www/config/common.neon
// source: /var/www/config/services.neon
// source: array
...
class Container_f6ec86b8e7 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		...
		$service->setMapping(['MiniCRM' => 'Mtr\MiniCRM\Presentation\*\**Presenter']);
		return $service;
	}
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('/var/www/www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_f6ec86b8e7 $container,
			) {
			}
